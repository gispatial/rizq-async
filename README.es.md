...
Async is a utility module which provides straight-forward, powerful functions for working with [asynchronous JavaScript](https://github.com/gispatial/rizq-async/global.html). Although originally designed for use with [Node.js](https://nodejs.org/) and installable via `npm install --save async`, it can also be used directly in the browser.
...
*For Async v1.5.x documentation, go [HERE](https://github.com/gispatial/rizq-asyncblob/v1.5.2/README.md)*
